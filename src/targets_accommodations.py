...
def make_target_page(template_path: str, city_name_for_path :str,
    ...
    if img_tag: img_tag['src'] = images[0].replace('http://20.240.63.21/files/images/accomodations', 'https://cheaptrip.guru/files/images/accommodations')
...
if __name__ == '__main__':
    source_jsons_folder = '/home/andrii/code/projects/CheapTripData/ContentAutomator/Contentio/GPT/content/seo/texts/accommodations/en'
    template_path = '/home/andrii/code/projects/CheapTripData/ContentAutomator/BudgetTravelTips/html_templates/accommodations/en/city/target.html'
    target_folder = '/home/andrii/code/projects/CheapTripData/ContentAutomator/BudgetTravelTips/tree/accommodations/en'
